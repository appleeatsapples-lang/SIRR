"""Armenian Alphabetic Numerals — COMPUTED_STRICT
Armenian alphabet: 36 letters with values 1-9, 10-90, 100-900, 1000-9000.
Source: Armenian numeral system (Mesrop Mashtots, 5th century)
"""
...
def compute(profile: InputProfile, constants: dict) -> SystemResult:
    ...
    letters = [(ch, ARMENIAN_MAP.get(ch, 0)) for ch in name if ch.isalpha()]
    total = sum(v for _, v in letters)
    root = reduce_number(total, keep_masters=(11, 22, 33))
    return SystemResult(
        id="armenian_gematria", name="Armenian Alphabetic Numerals",
        ...
        references=["Armenian numeral system via Latin phonetic transliteration"],
